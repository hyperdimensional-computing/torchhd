...
hdSequenceScratch = structures.DistinctSequence(DIMENSIONS)
list(
...
axSequence = structures.DistinctSequence(DIMENSIONS)
...
asSequence = structures.DistinctSequence(DIMENSIONS)
