        ...
        with torch.no_grad():
            ...
            Wout = (
                ...
                @ torch.linalg.pinv(
                    ...
                    + self.lamb * torch.diag(torch.var(total_samples_hv, 0))
                )
            )
...
print()
print(
    f"Dataset {dataset_id} - {RVFL_HYPERPARAMETERS[dataset_id][0]}: average testing accuracy of {(accuracy_dataset* 100):.3f}%"
)
