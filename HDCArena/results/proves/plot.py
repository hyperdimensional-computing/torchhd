...
mean_of_encoding_train_time = df.groupby(["method"])["train_time"].mean().round(3).reset_index().T
var_of_encoding_train_time = df.groupby(["method"])["train_time"].std().round(3).reset_index().T
